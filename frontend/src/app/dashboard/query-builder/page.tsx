...
import { Play, Zap, ShieldAlert, CheckCircle2, TrendingDown, Server, Database, Code2 } from "lucide-react";
...
export default function QueryBuilderPage() {
  ...
  const isCheap = result?.rating === "cheap";
                ...
                >
                  <div className={`p-6 rounded-3xl border ${isExpensive ? 'bg-rose-50 border-rose-200' : isCheap ? 'bg-emerald-50 border-emerald-200' : 'bg-amber-50 border-amber-200'} shadow-sm relative overflow-hidden`}>
                    ...
                    <div className="grid grid-cols-2 gap-4 relative z-10">
                      <div className="bg-white/60 p-4 rounded-2xl">
                        <p className="text-xs font-bold mb-1 opacity-70">Estimated Cost ($)</p>
                        <p className="text-2xl font-black">{result.cost_estimate?.dollar_cost_display || "$0.00"}</p>
                      </div>
                      <div className="bg-white/60 p-4 rounded-2xl">
                        <p className="text-xs font-bold mb-1 opacity-70">Relative DB Cost</p>
                  ...
                  <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-3 border-t border-slate-100">
                        <div className="flex justify-between text-sm mb-1">
                          <span className="font-bold text-slate-500">Carbon Footprint (Co2)</span>
