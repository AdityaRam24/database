            ...
            <div className="p-4 md:p-8 max-w-[1400px] mx-auto w-full">
                {statsLoading ? (
                    <div className="flex flex-col items-center justify-center h-64 gap-4 mt-6">
                        ...
                        <div className="text-gray-600 font-medium text-sm animate-pulse">Connecting to database...</div>
                    </div>
                ) : error ? (
                    <div className="flex flex-col items-center justify-center gap-4 bg-red-50 border border-red-100 rounded-3xl p-8 mt-6 text-center shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <p className="text-gray-500 font-medium text-xs mt-2 max-w-md mx-auto">
                    ...
                    <div className="flex items-center gap-4 px-5 py-4 bg-white border border-gray-200 rounded-2xl mt-6 shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-gray-600 font-medium text-xs mt-0.5">Use the sidebar to select a project or connect a new database.</p>
                        </div>
                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <div className="mb-6">
                            ...
                            <p className="text-gray-600 font-medium text-sm">High-level metrics for your selected database.</p>
                        </div>
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            <Card className="bg-white border border-gray-200 shadow-sm relative overflow-hidden group rounded-3xl">
                                ...
                                <CardContent className="relative z-10">
                                    ...
                                    <p className="text-xs text-gray-600 font-medium">PostgreSQL Disk Usage</p>
                                </CardContent>
                            </Card>
                            <Card className="bg-white border border-gray-200 shadow-sm relative overflow-hidden group rounded-3xl">
                                <div className="absolute -right-12 -top-12 opacity-50 group-hover:opacity-100 transition-opacity">
                                ...
                                <CardContent className="relative z-10">
                                    ...
                                    <p className="text-xs text-gray-600 font-medium">Active in 'public' schema</p>
                                </CardContent>
                            </Card>
                            <Card className="bg-white border border-gray-200 shadow-sm relative overflow-hidden group rounded-3xl">
                                <div className="absolute -right-12 -top-12 opacity-50 group-hover:opacity-100 transition-opacity">
                                ...
                                <CardHeader className="relative z-10 pb-2"><CardTitle className="text-gray-600 font-bold text-sm">Optimization Score</CardTitle></CardHeader>
                                <CardContent className="relative z-10">
                        ...
                        <Card className="bg-white border border-gray-200 shadow-sm flex flex-col mt-4 rounded-3xl">
                            <CardHeader className="border-b border-gray-100 pb-4 mb-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex gap-4 text-xs text-gray-600 font-bold pt-1">
